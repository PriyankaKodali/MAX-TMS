...
class MyReport extends Component{
    ...
    componentWillMount(){
        ...
        var url= ApiUrl + "/api/Activities/GetMyReport?fromDate=" + this.state.FromDate + 
        ...
        return(
            <div className="col-xs-12">
                   <div className=" SearchContainerStyle">
                    ...
                    <div className="col-xs-12" style={{marginLeft: '50%'}}>
                                      ...
                                      <div className="panel-heading"> 
                                         <h6 className="panel-title panelHeading" style={{ paddingTop: '6px'}}> 
                                             <p data-toggle="collapse" data-parent="#accordion"  href={"#collapse" + i}>
                                                       ...
                                                       <span> <b className="reportHeading" > Created Date : </b> {moment(ele["CreatedDate"]).format("DD-MMM-YYYY")} </span> 
                                                      <span> <b className="reportHeading"> Client/Dept : </b> {ele["Department"] != null ? ele["Department"] : <b> {ele["Client"]}</b>}  </span>  
                                                       { ele["Project"]!=null ? <span> <b className="reportHeading">  Project : </b> {ele["Project"]}  </span> : "" }
                                                       <span><b className="reportHeading">Subject : </b> {ele["Subject"]} </span>
                                             </p>
                                         </h6>
                                       </div>
