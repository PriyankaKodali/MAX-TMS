...
class LogReport extends Component{
                                            ...
                                            <div className="panel-body">
                                              {
                                                  ele["Task"].map((e, j) => {
                                                    return (
                                                        <div key={e["TaskId"]+ j} className="tasklog" >
                                                          <div>
                                                             <table className="table table-condensed table-bordered actionTable mytable">
                                                               <tbody>
                                                                   ...
                                                                   <tr>
                                                                       ...
                                                                       <td> {e["Department"] != null ? e["Department"] : e["Client"]} <span /></td>
    ...
    setRowStyle(logDate){
        ...
        // if(moment(fromDate).format("DD-MM-YYYY") >= moment(logDate).format("DD-MM-YYYY")
        // && (moment(logDate).format("DD-MM-YYYY") <=  moment(toDate).format("DD-MM-YYYY")) )
    ...
    clearClick(){
        this.refs.fromDate.value=moment().format("DD-MM-YYYY");
        this.refs.toDate.value=moment().format("DD-MM-YYYY");
        
        this.setState({Employee:'', Client:'',FromDate: moment().format('YYYY-MM-DD'),
