...
class Project extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            Clients: [], Client: null, Project: null, Projects: [], Items: [], ItemsList: itemsList,
            RequestedItems: [], StockRequest: [], Category: null, Categories: [], SubCategories: [],
            SubCategory: ''
        }
    }
    ...
    componentWillMount() {
        ...
        //     $.ajax({
        //         url: ApiUrl + "/api/StockRequest/GetStockRequest?stockReqId=" + this.props.match.params["Id"],
        //         type: "get",
        //         success: (data) => {
        //             this.setState({
        //                 StockRequest: data["stockRequest"], RequestedItems: ["stockRequestItems"],
        //                 Client: { value: data["stockRequest"]["Client"], label: data["stockRequest"]["ShortName"] },
        //                 Project: { value: data["stockRequest"]["Project"], label: data["stockRequest"]["ProjectName"] }
        ...
        return (
            <div className="container" >
                ...
                <form onSubmit={this.handleSubmit.bind(this)} onChange={this.validate.bind(this)}>
                    ...
                    <div className="itemRequestContainer" key={this.state.StockRequest} style={{ marginTop: '4%' }}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <div className="input-group">
                                                ...
                                                <input className="form-control" type="date" style={{ lineHeight: '19px' }} ref="stockDate" name="stockDate" defaultValue={this.state.StockRequest["ExpectedStockDate"]} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
